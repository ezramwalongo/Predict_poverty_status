...
class PovertyPredictor:
    ...
    def _tier_for(probability: float) -> str:
        """
        Four-tier classification matching the poverty status table:
          Very Poor : 0.76 - 1.00
          Poor      : 0.60 - 0.75
          Non Poor  : 0.26 - 0.50
          Rich      : 0.00 - 0.25
        ...
        Poor" here (i.e. Non Poor effectively covers [0.26, 0.60)). The
        table displayed to the user still shows the original 0.26-0.50
        range as given.
        """
        if probability >= 0.76:
            return 'very_poor'
            ...
            return 'well_off'  # displayed as "Rich"
