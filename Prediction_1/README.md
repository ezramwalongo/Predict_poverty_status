...
2. **New user?** Use the **Register** tab — username is your first name (letters only), password is exactly 8 digits
3. **Returning user?** Use the **Login** tab with your existing username/password
